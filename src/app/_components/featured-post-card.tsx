      ...
      <Link href={`/posts/${slug}`} className="block h-full">
        ...
        <div className="relative h-full flex flex-col justify-between p-6 text-white">
          ...
          <div className="space-y-4">
            <h3 className={`font-bold leading-tight text-white transition-all duration-300 ease-out group-hover:text-emerald-300 group-hover:transform group-hover:translate-y-[-2px] ${
