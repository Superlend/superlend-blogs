...
export function PostHeader({
  ...
  return (
    <header className="mb-12">
      ...
      <div className="lg:hidden flex flex-col sm:flex-row sm:items-center gap-4 md:gap-6 text-sm text-gray-600 dark:text-gray-400 border-l-4 border-primary pl-4 md:pl-6 py-3 md:mb-8">
