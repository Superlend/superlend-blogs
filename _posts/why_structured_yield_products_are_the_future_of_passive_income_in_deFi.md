...
- [Superfund](https://funds.superlend.xyz/super-fund/base) → Your onchain capital allocator on [Base Chain](https://www.base.org/).  
   Your USDC is routed across blue-chip protocols with automated risk controls, adaptive rebalancing, and real-time yield optimization. A true onchain savings product.
- [Superloop](https://loop.superlend.xyz/earn) → Smart looping vaults on [Etherlink](https://etherlink.com/).  
   It automates the entire leverage loop safely to amplify your earnings without the usual risks.
- [Superkat](https://www.superkat.xyz/) → A purpose-built, real-time yield engine on Katana.  
   It runs continuous simulations to find the best blended APY across strategies, using [Morpho](https://morpho.org/) for intelligent allocation.
